...
namespace CoursesManager.Tests.Students
{
    ...
    public class StudentViewModelBaseTests
    {
        ...
        {
            // Act
            var methodInfo = typeof(StudentViewModelBase).GetMethod("InitializeSelectableCourses",
            ...
            Assert.That(result.Any(c => c.Id == 2 && !c.IsSelected), Is.True,
                "Course with Id 2 should not be selected.");
        }
